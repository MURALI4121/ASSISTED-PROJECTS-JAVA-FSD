...
public class LockedMe {
    ...
    public static void mainMenu() {
        ...
        System.out.println("Enter \"1\" for showing current file names in ascending order ");
        System.out.println("Enter \"2\" for your Business Operation");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This project is Developed by K S MURALI");
        System.out.println("**********************");
